...
export default function BottomNavigation() {
    ...
    return (
        <div className="mt-5 flex flex-row bg-white w-full h-20 text-azul justify-content-around fixed bottom-0">
            <Link
                href='/'
                className={`flex flex-col justify-center items-center w-1/3 ${isActive('/') ? 'bg-gray-200 rounded-full my-2' : 'hover:text-gray-500'}`}
            >
            ...
            <Link
                ...
                className={`flex flex-col justify-center items-center w-1/3 ${isActive('/acompanhamentos') ? 'bg-gray-200 rounded-full my-2' : 'hover:text-gray-500'}`}
            >
